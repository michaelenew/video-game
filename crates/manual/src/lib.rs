...
pub const SECTIONS: &[Section] = &[
    ...
    Section {
        ...
        entries: &[
            ...
            e(
                "On your back",
                "The two bars are two wings, dark on the left and light on the right, each as long as its bar. Everybody in the arena can read them. Lopsided wings are a mage about to burn; full ones are a mage about to fly.",
            ),
            e(
                "The tip",
