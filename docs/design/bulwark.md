...
The Shifter comes from the old cities' duel tradition — the aristocrat's individual
...
**Shifter = the individual champion. Bulwark = the communal defender.** The contrast uses
